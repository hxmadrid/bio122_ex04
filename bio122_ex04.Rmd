...
msc <- read.csv("C:/Users/Xyrine/Documents/School Stuff/BS BIO 4th Year/1st Semester/BIO 118/Module 1/Module 1 - Laboratory Exercise/bio118-class/exercises/bio122-ex04/data/msc.csv")
...
roc <- read.csv("C:/Users/Xyrine/Documents/School Stuff/BS BIO 4th Year/1st Semester/BIO 118/Module 1/Module 1 - Laboratory Exercise/bio118-class/exercises/bio122-ex04/data/roc.csv")
...
shapiro.test(msc.cont$Velocity[msc.cont$Load == "X0.25"])  #  (p < 0.05)

shapiro.test(msc.cont$Velocity[msc.cont$Load == "X0.5"])   #  (p < 0.05)

shapiro.test(msc.cont$Velocity[msc.cont$Load == "X1"])     #  (p > 0.05) 

shapiro.test(msc.cont$Velocity[msc.cont$Load == "X1.5"])   #  (p > 0.05)

shapiro.test(msc.cont$Velocity[msc.cont$Load == "X2"])     #  (p > 0.05)
